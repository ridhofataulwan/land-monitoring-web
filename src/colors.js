...
export const colorsBgLight = {
  ...
  light: "bg-teal text-black dark:bg-slate-900/70 dark:text-white",
  contrast: "bg-gray-800 text-white dark:bg-white dark:text-black",
  success: "bg-emerald-500 border-emerald-500 text-white",
  danger: "bg-red-500 border-red-500 text-white",
  warning: "bg-yellow-500 border-yellow-500 text-white",
  info: "bg-teal-500 border-teal-500 text-white",
};
...
export const colorsOutline = {
  ...
  info: [colorsText.info, "border-teal-500"],
};
...
export const getButtonColor = (
  ...
  const colors = {
    ring: {
      ...
      info: "ring-teal-300 dark:ring-teal-700",
    },
    active: {
      white: "bg-gray-100",
      ...
      info: "bg-teal-700 dark:bg-teal-600",
    },
    bg: {
      white: "bg-white text-black",
    ...
    bgHover: {
      ...
      info: "hover:bg-teal-700 hover:border-teal-700 hover:dark:bg-teal-600 hover:dark:border-teal-600",
    },
    borders: {
      white: "border-white",
      ...
      info: "border-teal-600 dark:border-teal-500",
    },
    text: {
      ...
      info: "text-teal-600 dark:text-teal-500",
    },
    outlineHover: {
      contrast:
      ...
      info: "hover:bg-teal-600 hover:text-white hover:dark:text-white hover:dark:border-teal-600",
    },
  };
